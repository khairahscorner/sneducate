        ...
        <>
          ...
          >
            {isLoading ? (
              ...
              <div className="m-10 p-10 border border-solid border-gray-200">
                <div className="flex flex-wrap justify-between items-center">
                  <h1 className="head-text text-3xl text-medium mb-8">
                    Welcome,
    ...
    <div className="report-container">
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-2xl font-medium">School Report</h3>
          <div className="flex items-center">
            <p className="text-medium">Download:</p>
            <Button
              type="primary"
              extraClasses="w-auto ml-3 p-0 text-black"
              size="big"
              click={() => captureAndDownloadPDF("school-report.pdf")}
            >
              <span className=" w-5 h-5 cursor-pointer has-svg">
                <DownloadIcon />
              </span>
            </Button>
          </div>
        ...
        <div className="flex justify-around items-start pt-4 pb-10">
          <div className="mx-6 text-center">
            <div className="text-[48px] font-bold text-primary">
              {reportDetails?.staffCount}
            </div>
            <div className="text-black-600 font-medium text-sm">Staff</div>
          </div>
          <div className="mx-6 text-center">
            <div className="text-[48px] font-bold text-primary">
              {reportDetails?.totalStudentCount}
            </div>
            <div className="text-black-600 font-medium text-sm">Students</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-12">
          ...
          <div className="col-span-1 mx-5">
            ...
            <p className="italic text-p3 text-zinc-400 mb-4">
              progress level of students in evaluation with goals and targets
              defined in their IEPs.
            </p>
